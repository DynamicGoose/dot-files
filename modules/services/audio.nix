      ...
      let
        config = pkgs.writeText "pipewire.conf" ''
          ...
          context.exec = [
            ...
            #
            #{ path = "/nix/store/334afxah19b3hr6ll93pfxlcyhhh2vws-pipewire-1.4.9/bin/pipewire-media-session" args = ""
            ...
            #
            #{ path = "/nix/store/334afxah19b3hr6ll93pfxlcyhhh2vws-pipewire-1.4.9/bin/pipewire" args = [ "-c" "pipewire-pulse.conf" ]
